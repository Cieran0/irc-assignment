...
void client::NICK(irc::command parsedCommand) {
...
void client::PART(irc::command parsedCommand) {
    std::string channel_name = parsedCommand.arguments[0];
...
void client::PING(irc::command parsedCommand) {
...
void client::WHO(irc::command parsedCommand) {
    std::string channel_name = parsedCommand.arguments[0];
...
void client::MODE(irc::command parsedCommand) {
    std::string channel_name = parsedCommand.arguments[0];
    send_message(":" + server::host_name + " 324 "+info.nickname+" "+channel_name+" +\r\n");
}

void client::PRIVMSG(irc::command parsedCommand) {
...
void client::QUIT(irc::command parsedCommand) {
    is_active = false;
}
